...
//   return (
//     <div>
//       <h2 className="text-xl font-bold text-gray-400">Roles</h2>
//       <ul>
//         {roles.map((role: any) => (
...
//         <Link href="/dashboard/roles/add" className="px-4 py-2 bg-indigo-600 text-white rounded">
//           Add Role & Permission
//         </Link>
//       </div>

//       <table className="w-full border text-left text-gray-400">
